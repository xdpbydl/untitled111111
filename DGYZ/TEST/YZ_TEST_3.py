...
file_path = 'E:\\TEMP\\6TEST\\DGYC2\\源文件\\'
save_path = 'E:\\TEMP\\6TEST\\DGYC2\\'
model_path = 'E:\\TEMP\\6TEST\\DGYC2\\model\\'
...
def flag_no(i):
    ...
    if i == 2:
        df2 = source_data(source_file=source_file, header=data['r_header'], cols='指标代码',
