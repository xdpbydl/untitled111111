...
class SendMail(object):
    def __init__(self, username=None,title=None, passwd=None, recv=None, content=None,
        ...
        self.username = username # 用户名（发件人的邮箱账号或用户名）
        self.passwd = passwd # 16位的SMTP授权码（不含空格）
