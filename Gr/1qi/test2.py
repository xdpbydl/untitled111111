...
# 2022-08-17 1/4 修改export_soghuodan_all.xlsx文件
...
# 2022-08-25 1/4  区分配重块、対重块，增加'箱名'分组；
...
# 2022-08-25 2/4  区分配重块、対重块，增加'箱名'分组，对应’箱头描述‘；
...
print(df1)
print(len(df1))
df1.to_excel(f'{gv_Save_Path}19.xlsx', index=False)
input("--"*88)
...
# 2022-08-17 4/4物料编码.xlsx统一改为 日立对重块 规格对照表.xlsx文件
